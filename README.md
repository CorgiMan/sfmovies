...
### API Description
The API handles auto-complete, search and location based request. The API can also be queried for specific movies or scenes by providing the IMDB movie id, or scene id.
